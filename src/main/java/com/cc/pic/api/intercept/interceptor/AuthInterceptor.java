...
public class AuthInterceptor implements HandlerInterceptor {
    ...
    private static final String SIGN_FIELD = YmlConfig.getString("interface.sign.field");
    private static final String SIGN_NONCE = YmlConfig.getString("interface.sign.nonce");
    private static final String SIGN_TIMESPAN = YmlConfig.getString("interface.sign.timespan");
    private static final Long SIGN_LIMITED = YmlConfig.getLong("interface.sign.limited");
